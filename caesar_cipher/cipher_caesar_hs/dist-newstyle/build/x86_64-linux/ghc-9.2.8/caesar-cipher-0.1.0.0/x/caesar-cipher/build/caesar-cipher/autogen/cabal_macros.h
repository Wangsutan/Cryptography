...
/* package caesar-cipher-0.1.0.0 */
#ifndef VERSION_caesar_cipher
#define VERSION_caesar_cipher "0.1.0.0"
#endif /* VERSION_caesar_cipher */
#ifndef MIN_VERSION_caesar_cipher
#define MIN_VERSION_caesar_cipher(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_caesar_cipher */
...
#define CURRENT_COMPONENT_ID "caesar-cipher-0.1.0.0-inplace-caesar-cipher"
